...
{
    // filename based on date, and a list of entries
    ...
    public void Save()
    {
        List<string> lines = new List<string>(); // list of lines to write, starting with the readable date
